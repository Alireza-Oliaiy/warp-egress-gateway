...
Since `0.3.3`, dual-stack profiles generated by `wgcf` are normalized to this project's IPv4-only data path before `wg-quick` starts, preventing startup failures on hosts where IPv6 is disabled.
